...
export default function ProduccionPedidos ({pedidos, handleOpenModal} : {pedidos:Pedido[], handleOpenModal:(pedido:Pedido) => void}) {
    ...
    <TableContainer component={Paper}>
      <Table aria-label="collapsible table">
        ...
        <TableRow>
            ...
            <TableCell style={{color:'#ffffff'}} align="center">Cocinar</TableCell>
        </TableRow>
        </TableHead>
        <TableBody>

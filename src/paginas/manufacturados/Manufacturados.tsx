...
const Manufacturados = () => {
  ...
  const [errors, setErrors] = useState<{
    [key in keyof ArticuloManufacturado]?: string;
  }>({});
  ...
  const getManufacturadosRest = useCallback(async () => {
    try {
      ...
      const manufacturadosFiltrados = categoriaSeleccionada
        ? datos.filter(
            (manufacturado) =>
              manufacturado.categoria.id === categoriaSeleccionada
          )
        : datos;
  ...
  const handleEliminarEnSucursal = async (
    articuloManufacturado: ArticuloManufacturado
  ) => {
    if (
      articuloManufacturado.sucursales.some(
        (s) => s.id === sucursalSeleccionada.id
      )
    ) {
      articuloManufacturado.sucursales =
        articuloManufacturado.sucursales.filter(
          (s) => s.id !== sucursalSeleccionada.id
        );
    } else {
      articuloManufacturado.sucursales = [
    ...
    await articuloManufacturadoService.put(
  ...
  const handleSave = useCallback(async () => {
    ...
    if (articuloManufacturado.tiempoEstimadoMinutos <= 0) {
      erroresNuevos["tiempoEstimadoMinutos"] =
        "El tiempo estimado debe ser mayor a 0 minutos";
    } else if (articuloManufacturado.tiempoEstimadoMinutos >= 1000) {
      erroresNuevos["tiempoEstimadoMinutos"] =
        "El tiempo estimado es demasiado grande. Limítese a 3 cifras";
    }
    ...
    if (articuloManufacturado.resumen === "") {
      erroresNuevos["resumen"] =
        "Debe ingresar una descripción resumida del producto";
    }
    if (articuloManufacturado.descripcion === "") {
      erroresNuevos["descripcion"] =
        "Debe ingresar una descripción del producto";
    }
    if (articuloManufacturado.tiempoEstimadoMinutos! < 0) {
      erroresNuevos["tiempoEstimadoMinutos"] =
        "Debe ingresar el tiempo estimado de preparación del producto";
    } else if (articuloManufacturado.tiempoEstimadoMinutos >= 1000) {
      erroresNuevos["tiempoEstimadoMinutos"] =
        "El tiempo estimado es demasiado grande. limítese a 3 cifras";
    }
    ...
    if (articuloManufacturado.preparacion === "") {
      erroresNuevos["preparacion"] =
        "Debe ingresar la preparación del producto";
    }
    if (articuloManufacturado.articuloManufacturadoDetalles.length === 0) {
      erroresNuevos["articuloManufacturadoDetalles"] =
        "Debe definir al menos un ingrediente para el producto";
    }
  ...
  useEffect(() => {
    setCategoriasFiltradas(
      categorias.filter((categoria) =>
        manufacturados.some(
          (manufacturado) => manufacturado.categoria.id === categoria.id
        )
      )
    );
  }, [categorias]);
  ...
  useEffect(() => {
    if (sucursalSeleccionada) getManufacturadosRest();
                ...
                <div className="col">
                  <Box sx={{ margin: 1 }}>
                    ...
                    <Table size="small" aria-label="purchases">
                      <TableHead>
                        <TableRow>
                          <p className="mb-2">{row.resumen}</p>
                        </TableRow>
                        <TableRow>
                          <p style={{ fontSize: 11 }}>
                            <i>"{row.descripcion}"</i>
                ...
                <div className="col">
                  <Box sx={{ margin: 1 }}>
                    ...
                    <Table size="small" aria-label="purchases">
                      ...
                      <TableBody>
                        {row.articuloManufacturadoDetalles?.map(
                          (manufacturadoDetalle) => (
                            <TableRow key={manufacturadoDetalle.id}>
                              <TableCell component="th" scope="row">
                                {
                                  manufacturadoDetalle.articuloInsumo
                                    .denominacion
                                }
                              </TableCell>
                              <TableCell align="right">
                                {manufacturadoDetalle.cantidad!.toLocaleString(
                                  "es-AR"
                                )}{" "}
                                {
                                  manufacturadoDetalle.articuloInsumo
  ...
  const emptyRows =
    rowsPerPage -
    Math.min(rowsPerPage, manufacturados.length - page * rowsPerPage);
            ...
            <div className="row">
              <div className="col-lg-6 d-flex flex-column justify-content-between">
                <div className="mb-3 row">
                  <Form.Group className="col-12 mb-3" controlId="denominacion">
                  ...
                  <Form.Group className="col-12 mb-3" controlId="categoria">
                    ...
                    <div className="d-flex">
                      ...
                      <BtnAddCategory
                        openModal={() => setShowCategorias(true)}
                      />
                    </div>
                    {errors["categoria"] && (
                      <div className="ms-1 mt-1 text-danger">
                ...
                <div className="row">
                  <Form.Group className="col-12 mb-3" controlId="resumen">
                  ...
                  <Form.Group className="col-12 mb-3" controlId="descripcion">
                ...
                <div className="row">
                  <Form.Group className="col-6 mb-3" controlId="precioVenta">

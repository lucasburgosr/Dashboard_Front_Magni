...
export default function EmpresaSelect() {
  ...
  return (
    <div>
      ...
      >
        <div className="" style={{ alignItems: 'center', justifyContent: 'center', display: 'flex', overflow: 'hidden', backgroundColor: '#e0ebc2' }}>
          ...
          <ListItemButton
            ...
            style={{ backgroundColor: '#e0ebc2', color: '#fff' }}
          >
            <ListItemText
      ...
      >
        {empresas.map((option) => (
          <MenuItem
            ...
            style={{ backgroundColor: option.id === empresaSeleccionada.id ? '#5bbec0' : '#ffffff', color: '#333' }}
          >

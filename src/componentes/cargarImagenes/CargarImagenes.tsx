...
function CargarImagenes({imagenes, handleChange}: {imagenes: Imagen[], handleChange: (key: keyof object, value: any) => void}) {
    const [cargaEnProgreso, setCargaEnProgreso] = useState<boolean>(false);

    const urlimagenes = import.meta.env.VITE_IMG_API_URL;

    const handleImageDelete = (id:number) => {
        handleChange('imagenes' as keyof object, [...imagenes.filter((_imagen, index) => {return index != id})]);
    }
            ...
            try {
                ...
                await fetch(urlimagenes, {
                    ...
                    .then(response => {
                        ...
                        handleChange('imagenes' as keyof object, [...imagenes, imagen]);
    ...
    <div className="mb-3" >
        ...
        <Slider className='px-4 col-8 col-sm-8 col-lg-9 col-xl-10 text-center' {...settings}>
           {imagenes.map((imagen, index) => (
            ...
            <label className="col-4 col-sm-3 col-md-3 col-lg-3 col-xl-2 d-flex justify-content-center" htmlFor="imageInput">
                <div
                    style={{
                    width: '100px',
                    height: '100px',
